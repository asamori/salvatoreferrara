...
abstract class JHtmlSliders
{
	...
	{
		/* SF: modificato lo stile associato al pannello delle informazioni sul contatto e del modulo contatti */
		/*return '</div></div><div class="panel"><h3 class="pane-toggler title" id="' . $id . '"><a href="javascript:void(0);"><span>' . $text*/
		return '</div></div><div class="panel sf_contact_panel"><h3 class="pane-toggler title" id="' . $id . '"><a href="javascript:void(0);"><span>' . $text

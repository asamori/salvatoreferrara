...
<?php if ($this->contact->telephone && $this->params->get('show_telephone')) : ?>
	<p>
		<span class="<?php echo $this->params->get('marker_class'); ?>" >
			...
			<!-- SF: aggiunta label Telefono -->
			<?php echo JText::_('SF_CONTACT_DETAILS_TELEPHONE'); ?>
		</span>
...
<?php if ($this->contact->fax && $this->params->get('show_fax')) : ?>
	<p>
		<span class="<?php echo $this->params->get('marker_class'); ?>" >
			...
			<!-- SF: aggiunta label Fax -->
			<?php echo JText::_('SF_CONTACT_DETAILS_FAX'); ?>
		</span>
...
<?php if ($this->contact->mobile && $this->params->get('show_mobile')) :?>
	<p>
		<span class="<?php echo $this->params->get('marker_class'); ?>" >
			...
			<!-- SF: aggiunta label Cellulare -->
			<?php echo JText::_('SF_CONTACT_DETAILS_MOBILE'); ?>
		</span>
